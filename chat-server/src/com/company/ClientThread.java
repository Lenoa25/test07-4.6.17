...
public class ClientThread extends Thread {
    ...
    public ClientThread(Socket clientSocket, List<String> messages,List<String> messagesName, Map<String, String> users) {
    ...
    private void sendMessage() throws IOException {
        ...
        messagesName.add(user.getUserName());
    ...
    private void getMessages() throws IOException {
        ...
        for (int i = messageFrom; i < messages.size(); i++) {
            ...
            byte[] messageBytesUser =messagesName.get(i).getBytes();
            outputStream.write(messageBytesUser.length);
            outputStream.write(messageBytesUser);
        }
    }
